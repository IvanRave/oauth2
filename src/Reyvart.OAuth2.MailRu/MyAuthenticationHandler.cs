    ...
    public class MyAuthenticationHandler : AuthenticationHandler<MyAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                string tokenBody = "client_id=" + Uri.EscapeDataString(Options.AppId) +
                ...
                nvc.Add("method", Uri.EscapeDataString(Constants.UserGet.MethodName));
                nvc.Add("uids", Uri.EscapeDataString(userid));
                nvc.Add("uid", Uri.EscapeDataString(userid));
                nvc.Add("app_id", Uri.EscapeDataString(Options.AppId));
                nvc.Add("format", "xml");
                nvc.Add("secure", "1");
                ...
                string sig = Helpers.CryptoHelper.GetMd5Hash(paramString.ToString() + Options.AppSecret);

                // Add sig after calculate
                nvc.Add("sig", sig);
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:mailru:link", context.PhotoLink, XmlSchemaString, Options.AuthenticationType));
                }
