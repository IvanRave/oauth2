...
namespace Reyvart.OAuth2.Vkontakte
{
    ...
    /// </summary>
    [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "Vkontakte.MyAuthenticationOptions.set_Caption(System.String)", Justification = "Not localizable.")]
    public class MyAuthenticationOptions : AuthenticationOptions
    {
        ...
        {
            // Different for different social networks
