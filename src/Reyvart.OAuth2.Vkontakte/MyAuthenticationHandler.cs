    ...
    public class MyAuthenticationHandler : AuthenticationHandler<MyAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                string tokenRequest = Constants.Common.TokenEndpoint +
                                      "?client_id=" + Uri.EscapeDataString(Options.AppId) +
                ...
                string userInfoLink = Constants.Common.GraphApiEndpoint + "/" +
                                      Constants.UserGet.MethodName + ".xml" +
                                      "?user_ids=" + Uri.EscapeDataString(userid) +
                                      "&fields=" + Uri.EscapeDataString(string.Join(",", new string[]{ 
